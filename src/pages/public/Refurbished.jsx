...
import { CheckCircle2, ShieldCheck, Recycle } from 'lucide-react'
...
export default function Refurbished(){
  ...
  const list = products
  return (<>
    <PageHero kicker="Certified refurbished" title="Like new, properly verified" desc="Every refurbished device passes our full diagnostic before it's listed — tested, graded and backed by the same warranty as new.">
      <div className="flex items-center gap-2 mt-7 text-[13px] text-slate-300"><Recycle size={16} className="text-signal"/> Better for your wallet, better for the planet.</div>
    </PageHero>
    ...
    <section className="container-x section-pad">
      ...
      <div className="flex items-center gap-2.5 justify-center mt-10 text-[13px] text-graphite-500">
