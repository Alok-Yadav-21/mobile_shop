...
export function ProductCard({ p }){
  ...
  return (
    <Link to={`/products/${p.id}`} className="group block bg-white border border-graphite-200 rounded-2xl overflow-hidden transition-all duration-200 hover:border-brand/40 hover:shadow-elevate">
