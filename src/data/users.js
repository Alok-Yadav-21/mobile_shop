...
// `hourlyRate` (GBP/hour) is the basis for wage calculation — see src/lib/wages.js, which
// multiplies it by the hours derived from each staff member's shifts in src/data/shifts.js.
export const USERS = [
...
// Default hourly rate applied when a staff record predates the wage feature and has no rate set.
