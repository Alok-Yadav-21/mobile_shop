...
//
// `brand` is the manufacturer. Naming them is normal for a shop that repairs and resells other
// people's hardware — that is nominative use, not a trademark problem. Accessories a repair shop
// would sell as its own are branded Virktech.
//
// The same warning as the photographs applies to the brands: these are representative stock
// images, so a brand here describes the product being listed, not the exact unit in the picture.
// Before trading, both have to match the item actually on the shelf. One of these photos arrived
// from Unsplash labelled "Toshiba" and is plainly a Lenovo ThinkPad, which is why no brand here
// was taken from contributor alt text without looking at the image.
//
...
export const PRODUCTS = [
  // --- MacBooks -------------------------------------------------------------------------------
  { id:'p1', brand:'Apple', name:'MacBook Air 13" (refurbished)', category:'MacBooks', price:749, cond:'Refurbished', img:macbook, rating:4.9,
  ...
  { id:'p11', brand:'Apple', name:'MacBook Pro 14"', category:'MacBooks', price:1299, cond:'Used', img:macbookPro, rating:4.9,
  ...
  { id:'p12', brand:'Apple', name:'MacBook Air 15" (M2)', category:'MacBooks', price:1049, was:1149, cond:'New', img:macbookAirM2, rating:4.8,
  ...
  // --- iPhones --------------------------------------------------------------------------------
  { id:'p2', brand:'Apple', name:'iPhone 14 — 128GB', category:'iPhones', price:579, cond:'Used', img:iphone, rating:4.8,
  ...
  { id:'p13', brand:'Apple', name:'iPhone 13 — 128GB', category:'iPhones', price:449, was:499, cond:'Refurbished', img:iphoneTrio, rating:4.7,
  ...
  // --- Smartphones ----------------------------------------------------------------------------
  { id:'p7', brand:'Samsung', name:'Samsung Galaxy S23', category:'Smartphones', price:529, cond:'Used', img:samsung, rating:4.6,
  ...
  { id:'p14', brand:'Google', name:'Google Pixel 7', category:'Smartphones', price:329, cond:'Refurbished', img:pixel, rating:4.5,
  ...
  // --- Laptops --------------------------------------------------------------------------------
  { id:'p5', brand:'Acer', name:'Ultrabook 14"', category:'Laptops', price:699, cond:'New', img:laptop, rating:4.5,
  ...
  { id:'p15', brand:'Dell', name:'Dell XPS 13', category:'Laptops', price:849, cond:'Refurbished', img:dellXps, rating:4.7,
  ...
  { id:'p16', brand:'Virktech', name:'Gaming Laptop 15.6" RTX', category:'Laptops', price:1149, was:1299, cond:'New', img:gamingLaptop, rating:4.6,
  ...
  // --- Tablets --------------------------------------------------------------------------------
  { id:'p9', brand:'Apple', name:'iPad Air (refurbished)', category:'Tablets', price:429, cond:'Refurbished', img:tabletIpad, rating:4.8,
  ...
  { id:'p10', brand:'Samsung', name:'Galaxy Tab S9', category:'Tablets', price:379, was:429, cond:'New', img:tabletAndroid, rating:4.6,
  ...
  { id:'p17', brand:'Apple', name:'iPad mini 6', category:'Tablets', price:319, cond:'Used', img:tabletMini, rating:4.7,
  ...
  // --- Audio ----------------------------------------------------------------------------------
  { id:'p3', brand:'Virktech', name:'Over-ear Headphones', category:'Audio', price:129, was:149, cond:'New', img:headphones, rating:4.6,
  ...
  { id:'p6', brand:'Virktech', name:'Wireless Earbuds Pro', category:'Audio', price:99, was:129, cond:'New', img:earbuds, rating:4.8,
  ...
  { id:'p18', brand:'Virktech', name:'True Wireless Earbuds', category:'Audio', price:59, cond:'New', img:earpods, rating:4.4,
  ...
  { id:'p8', brand:'Virktech', name:'Bluetooth Speaker', category:'Audio', price:59, cond:'New', img:speaker, rating:4.7,
  ...
  // --- Wearables ------------------------------------------------------------------------------
  { id:'p4', brand:'Virktech', name:'Smartwatch Series X', category:'Wearables', price:199, cond:'New', img:watch, rating:4.7,
  ...
  { id:'p19', brand:'Virktech', name:'Fitness Band', category:'Wearables', price:39, was:49, cond:'New', img:fitnessBand, rating:4.3,
  ...
  // --- Accessories ----------------------------------------------------------------------------
  { id:'p20', brand:'Virktech', name:'USB-C Fast Charging Cable', category:'Accessories', price:12, cond:'New', img:charger, rating:4.5,
  ...
  { id:'p21', brand:'Virktech', name:'Power Bank 20,000mAh', category:'Accessories', price:34, was:44, cond:'New', img:powerbank, rating:4.6,
  ...
  { id:'p22', brand:'Virktech', name:'Protective Phone Case', category:'Accessories', price:15, cond:'New', img:phoneCase, rating:4.4,
  ...
  { id:'p23', brand:'Virktech', name:'Wireless Mouse', category:'Accessories', price:19, cond:'New', img:mouse, rating:4.3,
    desc:'Silent-click wireless mouse with a USB-C rechargeable battery that lasts about two months. Works on glass and fabric. Pairs over Bluetooth or the bundled dongle, so it suits an older laptop too.' },
  { id:'p24', brand:'Virktech', name:'Wireless Keyboard', category:'Accessories', price:29, was:35, cond:'New', img:keyboard, rating:4.4,
    desc:'Low-profile UK-layout keyboard, Bluetooth to three devices at once with a key to switch between them. Runs months on a charge. Handy if you use a laptop docked at a desk.' },
  { id:'p25', brand:'Virktech', name:'Laptop Sleeve 13-14"', category:'Accessories', price:22, cond:'New', img:laptopSleeve, rating:4.5,
    desc:'Padded felt sleeve that fits a 13 to 14-inch laptop, with a pocket for a charger. Slips inside a rucksack rather than replacing one. The cheapest way to stop the scuffs we see most often.' },

  { id:'p26', brand:'Apple', name:'Apple Watch Series 9', category:'Wearables', price:329, cond:'Refurbished', img:appleWatch, rating:4.8,
    desc:'41mm GPS, aluminium case with a sport band. Refurbished in branch: new battery where health was below 85%, screen checked, and reset. Pairs with iPhone only. Three-month warranty.' },
  { id:'p27', brand:'Apple', name:'AirPods Pro (2nd gen)', category:'Audio', price:179, was:229, cond:'Used', img:airpods, rating:4.7,
    desc:'Active noise cancelling with the MagSafe charging case. A trade-in: both buds tested and sanitised, case holds charge normally. Ear tips are new. Sold with a 30-day return.' },
  { id:'p28', brand:'Sony', name:'Sony On-ear Headphones', category:'Audio', price:35, cond:'New', img:sonyHeadphones, rating:4.4,
    desc:'Lightweight wired on-ear pair with a 3.5mm jack — no charging, no pairing, nothing to go flat. Folds for a bag. A sensible spare set, and it still works with a laptop or a mixing desk.' },
  { id:'p29', brand:'Lenovo', name:'ThinkPad T-series 15"', category:'Laptops', price:579, was:649, cond:'Refurbished', img:thinkpad, rating:4.6,
    desc:'Core i5, 16GB memory, 512GB SSD. Ex-corporate stock with the keyboard ThinkPads are bought for. Refurbished here: new battery, clean Windows 11 install, ports and fingerprint reader tested. Three-month warranty.' },
]
