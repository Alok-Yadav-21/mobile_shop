...
export const REPAIRS = [
  { ref:'SPR-4805', customer:'Maria Lopez', phone:'07700 900111', email:'maria@demo.com', branch:'wol', device:'Phone', brand:'Apple', model:'iPhone 13', problem:'Screen replacement', fulfilment:'In-store', status:'Ready for collection', quote:119, tech:'u4', createdAt:now-2*d,
